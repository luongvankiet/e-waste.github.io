...
const DataTable: React.FunctionComponent<DataTableProps> = (props) => {
    return <React.Fragment>
        ...
        <div className="row gutters-tiny">
                ...
                <a className="block block-rounded block-transparent bg-gd-sun" href="javascript:void(0)">
                    <div className="block-content block-content-full block-sticky-options">
                        ...
                        <div className="py-20 text-center">
                            <div className="font-size-h2 font-w700 mb-0 text-white" data-toggle="countTo" data-to="12">0</div>
            ...
            <div className="col-md-6 col-xl-3">
                <a className="block block-rounded block-transparent bg-gd-cherry" href="javascript:void(0)">
                    <div className="block-content block-content-full block-sticky-options">
                        ...
                        <div className="py-20 text-center">
                            <div className="font-size-h2 font-w700 mb-0 text-white" data-toggle="countTo" data-to="2">0</div>
            ...
            <div className="col-md-6 col-xl-3">
                <a className="block block-rounded block-transparent bg-gd-lake" href="javascript:void(0)">
                    <div className="block-content block-content-full block-sticky-options">
                        ...
                        <div className="py-20 text-center">
                            <div className="font-size-h2 font-w700 mb-0 text-white" data-toggle="countTo" data-to="21">0</div>
            ...
            {/* <!-- All --> */}
            <div className="col-md-6 col-xl-3">
                <a className="block block-rounded block-transparent bg-gd-dusk" href="javascript:void(0)">
                    <div className="block-content block-content-full block-sticky-options">
                        <div className="block-options">
                            <div className="block-options-item">
                        ...
                        <div className="py-20 text-center">
                            ...
                            <div className="font-size-sm font-w600 text-uppercase text-white-op">All</div>
                        </div>
                    </div>
                </a>
            </div>
